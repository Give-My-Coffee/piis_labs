...
function generateContent() {
    ...
    shirts.forEach((shirt, index) => { 
        // Создаем элемент и устанавливай класс
        ...
        //Добавляем эллемент в контейнер
...
function viewDetails(index) {
    localStorage.setItem('selectedShirt', index); /* сохраняет значение index под ключом 'selectedShirt' в localStorage */
